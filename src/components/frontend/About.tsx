        ...
        <div className="grid grid-cols-2 gap-4">
          {stats.map((item, index) => (
            <motion.div
              ...
              className={`relative aspect-square rounded-2xl overflow-hidden flex flex-col items-center justify-center border border-white/5 cursor-pointer transition-colors duration-300 ${
                item.type === "text" ? "bg-[#1a0a0a]" : "bg-gray-800"
              }`}
            >
