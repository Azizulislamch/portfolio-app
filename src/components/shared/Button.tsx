...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-red-800 text-white px-6 py-3 rounded-full text-lg shadow-red-600/20",
    iconOnly: "w-14 h-14 bg-red-800 text-white rounded-full text-xl shadow-red-600/20",
  };
